  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (ticketData && ticketData.id) {
        ...
        // Save in admin's tickets subcollection ONLY (not in main collection to avoid duplicates)
        const userTicketsRef = collection(db, 'mainData', 'Billuload', 'users', adminId, 'tickets');
        console.log('📂 AddTicket - Saving to path:', `mainData/Billuload/users/${adminId}/tickets`);
